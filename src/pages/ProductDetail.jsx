                                ...
                                <div className="col-xl-2 col-lg-2 col-md-2">
                                    <div className="single_product_tab">
                                        <div className="single_prodct">
                                            <ul className="nav nav-tabs justify-content-center mb-55" id="dfde"
                                                role="tablist">
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link active" id="home-tab"
                                                            data-bs-toggle="tab"
                                                            data-bs-target="#homde" type="button" role="tab"
                                                            aria-selected="true"><img src="assets/img/product/17.jpg"
                                                                                      alt=""/></button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link" id="profile-tab" data-bs-toggle="tab"
                                                            ...
                                                            aria-selected="false"><img src="assets/img/product/17-1.jpg"
                                                                                       alt=""/></button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link" data-bs-toggle="tab"
                                                            ...
                                                            type="button" role="tab"
                                                            aria-selected="false"><img src="assets/img/product/17-2.jpg"
                                                                                       alt=""/></button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link" id="kids-tab" data-bs-toggle="tab"
                                                            data-bs-target="#kidsdfd" type="button" role="tab"
                                                            aria-selected="false"><img src="assets/img/product/17-3.jpg"
                                                                                       alt=""/></button>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div className="col-xl-10 col-lg-10 col-md-10">
                                    <div className="single_preview_product">
                                        <div className="single-popup-view">
                                            <a className="popup-image" href="assets/img/product/17-3.jpg"><i
                            ...
                            <div className="single_preview_content pl-30">
                                ...
                                <div className="s-des">
                                    <p>Designed by Hans J. Wegner in 1949 as one of the first models created especially
                                        ...
                                        rounded top together with the back and seat offers a</p>
                                </div>
