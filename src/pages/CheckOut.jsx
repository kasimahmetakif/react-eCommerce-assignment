            ...
            <div className="checkout_area pt-80">
                <div className="container">
                    <div className="notification__message">
                        <p><i className="fal fa-window-maximize"></i>Returning customer? Click here to <a
                            href="login.html">login</a></p>
                        <p><i className="fal fa-window-maximize"></i>Have a coupon? Click here to enter your code</p>
                    </div>
                    <div className="row">
                            ...
                            <div className="checkout_form mb-100">
                                <form action="#">
                                    ...
                                    <div className="checkout__wrap">
                                        ...
                                        <input className="mb-20" type="text" name="add1"
